...
#Remove degree
df_students = df_students.drop("degree", axis=1)
...
#Unix converter
df_students['start_date'] = pd.to_datetime(df_students['start_date'], format="%d-%m-%Y").astype(np.int64) / 10**9
...
#Times KD with ECTS
#df_students['kd'] = df_students['kd']*df_students['ects_points']